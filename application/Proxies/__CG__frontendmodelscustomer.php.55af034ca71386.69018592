 ...
 */
class customer extends \frontend\models\customer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'frontend\\models\\customer' . "\0" . 'id', '' . "\0" . 'frontend\\models\\customer' . "\0" . 'name', '' . "\0" . 'frontend\\models\\customer' . "\0" . 'cart');
        }
