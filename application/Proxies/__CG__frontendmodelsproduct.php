 ...
 */
class product extends \frontend\models\product implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'frontend\\models\\product' . "\0" . 'id', '' . "\0" . 'frontend\\models\\product' . "\0" . 'name', '' . "\0" . 'frontend\\models\\product' . "\0" . 'shipping', '' . "\0" . 'frontend\\models\\product' . "\0" . 'features');
        }
