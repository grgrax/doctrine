...
$config['auth_override_class_method']['ping']['public'] = 'none';
$config['auth_override_class_method']['ping']['private'] = 'digest';

$config['auth_override_class_method']['api']['category'] = 'none';

$config['auth_override_class_method']['api']['users'] = 'basic';
// $config['auth_override_class_method']['api']['user'] = 'digest';
